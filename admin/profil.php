        ...
        <div class="section">
            <div class="container">
                ...
                <form id="contact" action="" method="post">
                    ...
                    <fieldset>
                        <button type="submit" name="submit" id="contact-submit" data-submit="...Sending">Ubah Profil</button>
                    </fieldset>
                </form>
                <?php 
                ...
                <form id="contact" action="" method="post">
                    <h3>Ubah Password</h3>
                    <fieldset>
                        <input type="password" name="pass1" placholder="Password Baru" class="form-control" required>
                    </fieldset>
                    <fieldset>
                        <input type="password" name="pass2" placholder="Konfirmasi Password Baru" class="form-control" required>
                    </fieldset>
                    <fieldset>
                        <button type="submit" name="ubah_password" id="contact-submit" data-submit="...Sending">Ubah Password</button>
                    </fieldset>
                </form>
                <?php
