...
<body>
    ...
    <header>
        <div class="container">
            <h1><a href="index.php">JajanD JalanD</a></h1>
            <ul>
    ...
    <div class="search">
        <div class="container">
            <p>Silahkan login untuk berbelanja</p><a href="login.php"><b>Click Here</b></a>
        </div>
    </div>
    ...
    <div class="footer">
        <div class="container">
            ...
            <small>Copyright &copy; 2026 - JajanD JalanD.</small>
        </div>
    </div>
</body>
</html>